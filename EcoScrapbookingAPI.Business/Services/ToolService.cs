...
public class ToolService : IToolService
{
  ...
  {
    var tool = new Tool(toolCreateDTO.Name, toolCreateDTO.Type, toolCreateDTO.Brand, toolCreateDTO.Quantity, toolCreateDTO.Description, toolCreateDTO.OwnerUserId, toolCreateDTO.ImageResourceUrl, toolCreateDTO.TransactionId, toolCreateDTO.Condition, toolCreateDTO.Warranty);
